    ...
    return (
        <div>
            ...
            <form onSubmit={onSubmit} className="bg-slate-300 p-3 mt-5 rounded-xl text-gray-950">
                ...
                <button type="submit" className="bg-sky-500 hover:bg-sky-600 text-white px-3 py-2 mt-3 rounded-lg cursor-pointer transition-colors flex items-center justify-center">
                    <span>Consultar</span>
